...
/// is: its maths never cared which axis it was on, only that it had one. This
/// type turns a stack-space coordinate into a point in the panel, whose origin
/// is top-left (`NSHostingView` is flipped, and so is SwiftUI's
